	...
	if (mysql_num_rows($q)==0)
		...
		echo "Nema niti jednog učenika u imeniku!<br>";
				...
				while ($redak=mysql_fetch_array($q))
					...
					<tr>
					<td width="180">
					<a href="vladanje.php?razred_id=<?=$redak["razred_id"]?>&opu_id=<?=$redak["opu_id"]?>"> <span class="style12">
					<?=$redak["rbr_ucenika"]?>
					. 
   ...
   <?
	...
	if (mysql_num_rows($vl)==1)
		...
		<?
				...
				?>
	<br />
 	<a href="vladanje_unos.php?razred_id=<?=$_GET["razred_id"]?>&opu_id=<?=$_GET["opu_id"]?>"><br>
    Unesi vladanje učenika za prvo polugodište!<br /></a>
	<?
					}
	...
	die();
		...
		if($v == null)
			...
			?>
	<br />
 	<a href="vladanje_unos_kraj.php?razred_id=<?=$_GET["razred_id"]?>&opu_id=<?=$_GET["opu_id"]?>"><br>
    Unesi vladanje učenika za kraj godine!</a>
	<?
