...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="position:relative; left: -500px; top: 0px;">
 ...
 <table width="300" height="506" border="0" cellpadding="0" cellspacing="0">
  ...
  <ul>
  <ul>
    <li><a href="razredi.php?naziv_skole=<?=$_GET["naziv_skole"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>">Povratak</a></li>
  ...
  <ul>
  <ul>
  <li><a href="stat_razm.php?razred_id=<?=$_GET["razred_id"]?>&naziv_skole=<?=$_GET["naziv_skole"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>">Statistika<br> razreda</a></li>
  </ul>
  </ul>
  <hr width="180"/>
 <br />
			...
			<br /><br />
				...
				while ($redak=mysql_fetch_array($q))
					...
					<td width="300"> <?=$redak["prezime_ucenika"]?> <?=$redak["ime_ucenika"]?> <hr /></td>
      				<td width="100"><a href="imenikm.php?razred_id=<?=$redak["razred_id"]?>&opu_id=<?=$redak["opu_id"]?>&naziv_skole=<?=$_GET["naziv_skole"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>"> Pogledaj </a>
      				  <hr /></td>
    				</tr>
					<?	
					}
