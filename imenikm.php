...
?></th>
	  ...
	  $opu= $_GET["opu_id"]; 
	  $sql="Select * from osobni_podaci_ucenika where opu_id = '$opu'";
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="position:relative; left: -500px; top: 0px;">
 ...
 <table width="300" height="506" border="0" cellpadding="0" cellspacing="0">
  ...
  <ul>
	...
	<ul>
  <ul>
    <li><a href="razredm.php?naziv_skole=<?=$_GET["naziv_skole"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>&razred_id=<?=$_GET["razred_id"]?>">Razred</a></li>
...
if (!$q=mysql_query($sql))
	...
	if (mysql_num_rows($q)==0)
		...
		echo "Nema niti jednog učenika u imeniku!<br>";
				...
				while ($redak=mysql_fetch_array($q))
					...
					<tr>
					<td width="180">
					<a href="imenikm.php?razred_id=<?=$redak["razred_id"]?>&opu_id=<?=$redak["opu_id"]?>&naziv_skole=<?=$_GET["naziv_skole"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>" class="style12"> <span class="style12">
					<?=$redak["rbr_ucenika"]?>
					. 
 ...
 if(mysql_num_rows($oc) > 0)
  ...
  <tr>
    <td width="147" rowspan="2" bgcolor="#BEB4FC"><div align="center"><strong>Završne ocjene </strong> </div></td>
