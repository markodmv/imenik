...
<title>Unos opisnog praćenja</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="700" height="506" border="0" cellpadding="0" cellspacing="0">
  ...
  if (!$_POST["SBunos"])
	...
	?>
<br />
Unesite opisno praćenje:
<br />
	<form method="post" action="">
	<input type="text" name="podatak" size="70" />
	<br />
<br />
<input type="submit" name="SBunos" value="Pohrani" />
	...
	$oprac="insert into opisno_pracenje(podatak, korisnik_id, razred_id, opu_id, predmet_id, datum) values('$_POST[podatak]', '$kid', '$rid', '$opu', '$_GET[predmet_id]', '$dat')";
	if(!$op=mysql_query($oprac)){echo "<br>Nastala je greška pri izvođenju upita!<br>".mysql_query();}
	else
	{ header("Location: imenik.php?razred_id=$_GET[razred_id]&opu_id=$_GET[opu_id]"); }	
		}
				}
