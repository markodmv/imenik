...
$check = mysql_query("SELECT korisnicko_ime FROM mzos WHERE korisnicko_ime = '$usercheck'") 
or die(mysql_error());
$check2 = mysql_num_rows($check);
	...
	if ($check2 != 0) 
	{
	die('Korisnicko ime '.$_POST['Korisnicko_ime'].' vec postoji.<br><br> <div class="style6"><a href="registracija_ministarstvo.php">Ponovi unos.</a></div>');
	}


		if ($_POST['lozinka'] != $_POST['pass2']) 
		{
		die('Neispravna lozinka.<br><br> <div class="style6"><a href="registracija_ministarstvo.php">Ponovi unos.</a></div>');
		}
...
$insert = "INSERT INTO mzos (korisnicko_ime, lozinka)
VALUES ('".$_POST['korisnicko_ime']."', '".$_POST['lozinka']."')";
$add_member = mysql_query($insert);
?>
<br>Uspješno ste registrirani!
<br>
<p>Možete se prijaviti <a href="../skolski_imenik/ministarstvo_login.php">ovdje</a>.</p>
