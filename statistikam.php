	...
	if (mysql_num_rows($q)==0)
		...
		echo "Nema niti jednog učenika u imeniku!<br>";
				...
				while ($redak=mysql_fetch_array($q))
					...
					<tr>
					<td width="180">
					<a href="statistikam.php?razred_id=<?=$redak["razred_id"]?>&amp;opu_id=<?=$redak["opu_id"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>&naziv_skole=<?=$_GET["naziv_skole"]?>" class="style12"> <span class="style12">
					<?=$redak["rbr_ucenika"]?>
					. 
