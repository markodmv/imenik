...
<table width="1000" border="0" cellspacing="0" cellpadding="0" style="position:relative; left: -500px; top: 0px;">
 ...
 <table width="300" height="506" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<ul>
  <ul>
    <li><a href="razredm.php?naziv_skole=<?=$_GET["naziv_skole"]?>&mjesto_skole=<?=$_GET["mjesto_skole"]?>&razred_id=<?=$_GET["razred_id"]?>">Povratak</a></li>
...
<table width="340" border="1" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#BEB4FC" class="style15">Muški</td>
    <td align="center" bgcolor="#BEB4FC" class="style15">Ženski</td>
